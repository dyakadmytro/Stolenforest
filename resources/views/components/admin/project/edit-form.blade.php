<form action="{{route('projects.update', ['project' => $project->id])}}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    @csrf
    ...
    <div class="mb-4">
        ...
        <textarea id="description" name="description" value="{{$project->description}}" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" ></textarea>
    </div>
